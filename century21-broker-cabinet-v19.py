...
<div style="padding: 12px; border-radius: 4px; background-color: #1A1A1A; border: 1px solid #2D2D2D; text-align: center;">
    <p style="font-size: 0.8rem; margin: 0; color: #C5A059; font-family: 'Barlow', sans-serif; font-weight: 700; text-transform: uppercase; letter-spacing: 1px;"><b>Версия MVP: 19.0 (Премиальная Экосистема C21)</b></p>
...
# ==============================================================================
    ...
    tab_8weeks, tab_13steps, tab_registration, tab_legal_tech = st.tabs([
    ...
    with tab_registration:
        ...
        with col_reg2:
            ...
            # 1. Jur Name Checker
            legal_input = st.text_input("1. Название юридического лица (например: ООО 'Риэлт-Групп'):", "ООО 'С21 Недвижимость'")
            if legal_input:
            ...
            # 2. DBA Checker
            dba_input = st.text_input("2. Коммерческое наименование (DBA) (например: CENTURY 21 Панорама Риэлти):", "CENTURY 21 Недвижимость Сочи")
            if dba_input:
            ...
            # 3. Domain Checker
            domain_input = st.text_input("3. Планируемое доменное имя (URL) (например: c21panorama.ru):", "goldteamrealty-c21.com")
            if domain_input:
...
def show_corporate_footer():
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; color: #888888; font-size: 0.8rem; font-family: 'Barlow', sans-serif;">
        <div><b>©2026 CENTURY 21 Россия</b> • Корпоративная экосистема брокера v19.0 (Регистрация & Юридический комплаенс v13). CENTURY 21® зарегистрированный товарный знак (знак обслуживания), принадлежит компании Century 21 Real Estate LLC. [83]</div>
