...
<div style="padding: 10px; border-radius: 5px; background-color: #252525; text-align: center;">
    <p style="font-size: 0.8rem; margin: 0; color: #C5A059;"><b>Версия MVP: 4.0</b></p>
    <p style="font-size: 0.75rem; margin: 5px 0 0 0; color: #888888;">Интегрированы все 12 продуктов (включая личный архив целей агентов Victory Group)</p>
</div>
""", unsafe_allow_html=True)
...
# ==============================================================================
    ...
    st.markdown("""
    # 🎯 Личный планировщик целей агента <span class="brand-gold-text">(Обратная воронка)</span>
    Установите свой желаемый финансовый результат, и система рассчитает, сколько звонков, встреч и договоров вам необходимо совершить на основе ваших конверсий.
    """, unsafe_allow_html=True)
    ...
    st.markdown("""
    # 💰 Калькулятор доходности сделок (Unit Economics)
    Детальный расчет рентабельности отдельной сделки купли-продажи недвижимости с учетом роялти, налогов, выплат агенту и РОПу по стандартам CENTURY 21.
    """, unsafe_allow_html=True)
