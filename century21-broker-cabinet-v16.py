...
if 'brand_gold' not in st.session_state:
    st.session_state['brand_gold'] = '#BEAF87'
if 'brand_charcoal' not in st.session_state:
    st.session_state['brand_charcoal'] = '#252526'
...
<style>
    ...
    section[data-testid="stSidebar"] {
        ...
        border-right: 2px solid #BEAF87 !important;
    }
...
<div style="text-align: center; padding: 15px 0px; background-color: #252526; border-radius: 4px; margin-bottom: 15px;">
    <h1 style="color: #BEAF87 !important; margin: 0; font-size: 1.95rem; font-family: 'Montserrat', sans-serif; font-weight: 300; letter-spacing: 5px; text-shadow: 1px 1px 2px rgba(0,0,0,0.5);">CENTURY 21</h1>
    <p style="color: #FFFFFF; font-size: 0.85rem; margin: 5px 0 0 0; font-family: 'Montserrat', sans-serif; font-weight: 600; text-transform: uppercase; letter-spacing: 2px;">Россия</p>
    <div style="border-top: 2px solid #BEAF87; width: 60px; margin: 15px auto 10px auto;"></div>
    <p style="color: #BEAF87; font-size: 0.72rem; font-family: 'Montserrat', sans-serif; font-weight: 700; letter-spacing: 3px; margin: 0; text-transform: uppercase;">Smarter. Bolder. Faster.</p>
</div>
...
<div style="padding: 12px; border-radius: 4px; background-color: #252526; border: 1px solid #2D2D2D; text-align: center;">
    <p style="font-size: 0.8rem; margin: 0; color: #BEAF87; font-family: 'Montserrat', sans-serif; font-weight: 700; text-transform: uppercase; letter-spacing: 1px;"><b>Версия MVP: 9.0 (Финальный Корпоративный Релиз)</b></p>
    <p style="font-size: 0.75rem; margin: 5px 0 0 0; color: #CCCCCC; font-family: 'Montserrat', sans-serif; line-height: 1.4;">Корпоративный релиз CENTURY 21, полностью соответствующий BrandBook Россия по палитре, шрифтам и правилам</p>
</div>
<div style="margin-top: 20px; text-align: center;">
    <p style="font-size: 0.65rem; color: #888888; font-family: 'Montserrat', sans-serif; line-height: 1.4; letter-spacing: 0.5px;">«Каждый офис находится в независимом владении и управлении.»</p>
</div>
""", unsafe_allow_html=True)
...
if menu == "📊 Главный дашборд & What-If":
    st.markdown("""
    <div style="background-color: #252526; padding: 25px 30px; border-left: 5px solid #BEAF87; border-radius: 4px; margin-bottom: 30px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
        <h1 style="color: #FFFFFF !important; margin: 0; font-size: 2.1rem; letter-spacing: 3px; font-weight: 700; font-family: 'Montserrat', sans-serif; text-transform: uppercase;">БИЗНЕС-СИМУЛЯТОР "WHAT-IF"</h1>
        <p style="color: #BEAF87; margin: 8px 0 0 0; font-size: 0.95rem; text-transform: uppercase; letter-spacing: 1.5px; font-weight: 600;">Сквозная воронка рекрутинга и продаж, совмещенная со сценарным финансовым симулятором</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with col_s1:
        st.markdown("<h4 style='color: #BEAF87 !important;'>1. Рекрутинг и Кадры</h4>", unsafe_allow_html=True)
    ...
    with col_s2:
        st.markdown("<h4 style='color: #BEAF87 !important;'>2. Активность и Продажи</h4>", unsafe_allow_html=True)
    ...
    with col_s3:
        st.markdown("<h4 style='color: #BEAF87 !important;'>3. Финансовые допущения</h4>", unsafe_allow_html=True)
    ...
    with col_ch1:
        ...
        fig_rec = go.Figure(go.Funnel(
            ...
            marker=dict(color=["#252526", "#333333", "#BEAF87", "#D9C193", "#EAE0CE"])
        ))
    ...
    with col_ch2:
        ...
        fig_sales = go.Figure(go.Funnel(
            ...
            marker=dict(color=["#BEAF87", "#D9C193", "#EAE0CE", "#252526"])
        ))
    ...
    with col_be1:
        ...
        <div style="background-color: #FFFFFF; padding: 20px; border-radius: 8px; border: 1px solid #EAEAEA;">
            <h4 style="color: #252526; margin-top: 0;">Показатели безубыточности:</h4>
            ...
            <p style="margin: 10px 0; font-size: 1.1rem; color: #BEAF87;"><b>🎯 Точка безубыточности:</b></p>
    ...
    with col_be2:
        ...
        fig_be = go.Figure()
        fig_be.add_trace(go.Scatter(x=deals_range, y=revenue_line, name="Выручка (ВКД)", line=dict(color="#BEAF87", width=3)))
        fig_be.add_trace(go.Scatter(x=deals_range, y=costs_line, name="Совокупные расходы", line=dict(color="#252526", width=2, dash="dash")))
...
# ==============================================================================
    ...
    st.markdown("""
    <div style="background-color: #252526; padding: 25px 30px; border-left: 5px solid #BEAF87; border-radius: 4px; margin-bottom: 30px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
        <h1 style="color: #FFFFFF !important; margin: 0; font-size: 2.1rem; letter-spacing: 3px; font-weight: 700; font-family: 'Montserrat', sans-serif; text-transform: uppercase;">ИНТЕЛЛЕКТУАЛЬНЫЙ РАСЧЕТ KPI</h1>
        <p style="color: #BEAF87; margin: 8px 0 0 0; font-size: 0.95rem; text-transform: uppercase; letter-spacing: 1.5px; font-weight: 600;">Ведомость автоматического расчета окладов, премий и стипендий для всей команды с автоконтролем весов</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    if role == "Агент-Новичок (Адаптация)":
        ...
        with col_ag2:
            ...
            st.markdown(f"""
            <div style="background-color: #FFFFFF; padding: 20px; border-radius: 8px; border: 1px solid #EAEAEA;">
                <h4 style="color: #252526; margin-top: 0;">Справка о начислении стажеру:</h4>
                ...
                <h3 style="color: #BEAF87 !important; margin-top: 10px;">💵 ВСЕГО К ВЫПЛАТЕ: {total_earned:,.0f} ₽</h3>
            </div>
            """, unsafe_allow_html=True)
        ...
        with col_hr2:
            ...
            st.markdown(f"""
            <div style="background-color: #FFFFFF; padding: 20px; border-radius: 8px; border: 1px solid #EAEAEA;">
                <h4 style="color: #252526; margin-top: 0;">Справка о начислении HR:</h4>
                ...
                <hr style="border-top: 1px solid #EEE;">
                <h3 style="color: #BEAF87 !important; margin-top: 10px;">💵 ВСЕГО К ВЫПЛАТЕ: {total_hr_salary:,.0f} ₽</h3>
            </div>
            """, unsafe_allow_html=True)
        ...
        with col_rop2:
            ...
            st.markdown(f"""
            <div style="background-color: #FFFFFF; padding: 20px; border-radius: 8px; border: 1px solid #EAEAEA;">
                <h4 style="color: #252526; margin-top: 0;">Справка о начислении РОПу:</h4>
                ...
                <hr style="border-top: 1px solid #EEE;">
                <h3 style="color: #BEAF87 !important; margin-top: 10px;">💵 ВСЕГО К ВЫПЛАТЕ: {total_rop_income:,.0f} ₽</h3>
            </div>
            """, unsafe_allow_html=True)
...
# ==============================================================================
    ...
    st.markdown("""
    <div style="background-color: #252526; padding: 25px 30px; border-left: 5px solid #BEAF87; border-radius: 4px; margin-bottom: 30px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
        <h1 style="color: #FFFFFF !important; margin: 0; font-size: 2.1rem; letter-spacing: 3px; font-weight: 700; font-family: 'Montserrat', sans-serif; text-transform: uppercase;">🤝 Welcome-Центр & Онбординг</h1>
        <p style="color: #BEAF87; margin: 8px 0 0 0; font-size: 0.95rem; text-transform: uppercase; letter-spacing: 1.5px; font-weight: 600;">История бренда, Золотой стандарт качества и мотивационный трекер CENTURION</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with tab_welcome:
        ...
        st.markdown(f"""
        <div style="background-color: #FFFFFF; padding: 25px; border-left: 5px solid #BEAF87; border-radius: 4px; box-shadow: 0 4px 15px rgba(0,0,0,0.02); margin-top: 15px;">
            <h4 style="color: #BEAF87; margin-top:0;">{selected_year} — {veha['title']}</h4>
        ...
        st.markdown(f"""
        <div style="background-color: #F1EAD3; padding: 20px; border-radius: 4px; border: 1px solid #BEAF87; margin-top: 25px;">
            <h4 style="color: #252526; margin-top: 0; text-transform: uppercase;">🌟 СИНЕРГИЯ СИСТЕМЫ CENTURY 21</h4>
    ...
    with tab_swot:
        ...
        with col_sw1:
            ...
            <div style="background-color: #E2EFDA; padding: 20px; border-left: 5px solid #375623; border-radius: 4px; height: 100%; min-height: 380px;">
                ...
                <ul style="font-size: 0.95rem; line-height: 1.5; color: #252526;">
    ...
    with tab_centurion:
        ...
        with col_c_res:
            ...
            if needed_deals_year >= 60:
                ...
                status_color = "#EAEAEA"
                status_text_color = "#252526"
                
            st.markdown(f"""
            <div style="background-color: {status_color}; padding: 25px; border-radius: 4px; border: 2px solid #BEAF87; text-align: center; color: {status_text_color};">
    ...
    with tab_slides:
        ...
        if "Миссия" in slide_num:
            st.markdown("""
            <div class="c21-card" style="border-left: 5px solid #BEAF87;">
                <h3 style="color: #BEAF87 !important; margin-top: 0;">ЗОЛОТОЙ СТАНДАРТ РИЭЛТОРСКИХ УСЛУГ И БИЗНЕСА В НЕДВИЖИМОСТИ</h3>
            ...
            st.markdown("""
            <div class="c21-card" style="border-left: 5px solid #252526;">
                <h3 style="color: #252526 !important; margin-top: 0;">ПРЕИМУЩЕСТВА И ОСОБЕННОСТИ ПРОФЕССИИ АГЕНТА</h3>
                <p style="font-size: 1.05rem; line-height: 1.6; color: #222222;">
            ...
            st.markdown("""
            <div class="c21-card" style="border-left: 5px solid #BEAF87;">
                <h3 style="color: #BEAF87 !important; margin-top: 0;">CREATE 21 — ФУНДАМЕНТ УСПЕШНОЙ КАРЬЕРЫ</h3>
                <p style="font-size: 1.05rem; line-height: 1.6; color: #222222;">
            ...
            st.markdown("""
            <div class="c21-card" style="border-left: 5px solid #252526;">
                <h3 style="color: #252526 !important; margin-top: 0;">МАРКЕТИНГОВЫЕ МАТЕРИАЛЫ И ПОЛИГРАФИЯ БРЕНДА</h3>
                <p style="font-size: 1.05rem; line-height: 1.6; color: #222222;">
            ...
            st.markdown("""
            <div class="c21-card" style="border-left: 5px solid #BEAF87;">
                <h3 style="color: #BEAF87 !important; margin-top: 0;">21-ONLINE И МУЛЬТИЛИСТИНГОВАЯ СИСТЕМА (МЛС)</h3>
                <p style="font-size: 1.05rem; line-height: 1.6; color: #222222;">
    ...
    st.markdown("""
    <div style="background-color: #252526; padding: 25px 30px; border-left: 5px solid #BEAF87; border-radius: 4px; margin-bottom: 30px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
        <h1 style="color: #FFFFFF !important; margin: 0; font-size: 2.1rem; letter-spacing: 3px; font-weight: 700; font-family: 'Montserrat', sans-serif; text-transform: uppercase;">ФИНАНСОВОЕ ПЛАНИРОВАНИЕ ОФИСА (Лист1)</h1>
        <p style="color: #BEAF87; margin: 8px 0 0 0; font-size: 0.95rem; text-transform: uppercase; letter-spacing: 1.5px; font-weight: 600;">Детальный расчет постоянных затрат, расчет точки безубыточности (ТБ) и сценарное планирование целевой прибыли</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with col_fp1:
        st.markdown("<h4 style='color: #BEAF87 !important;'>🏢 1. СОДЕРЖАНИЕ ОФИСА & ПОСТОЯННЫЕ ЗАТРАТЫ</h4>", unsafe_allow_html=True)
        ...
        *   Итого затраты на персонал (ФОТ): **{total_payroll_exp:,.0f} руб.**
        ...
        st.markdown(f"""
        <div style="background-color: #252526; padding: 15px; border-radius: 4px; border-left: 5px solid #BEAF87; text-align: center;">
            <p style="color: #FFFFFF; margin: 0; font-size: 0.95rem; text-transform: uppercase;"><b>Итого Постоянные Затраты офиса:</b></p>
            <h3 style="color: #BEAF87 !important; margin: 5px 0 0 0; font-size: 1.8rem; font-weight: 800;">{total_fixed_expenses:,.0f} ₽ / мес.</h3>
        </div>
        """, unsafe_allow_html=True)

    with col_fp2:
        st.markdown("<h4 style='color: #BEAF87 !important;'>📊 2. ТОЧКА БЕЗУБЫТОЧНОСТИ & ПЛАНИРОВАНИЕ ПРИБЫЛИ</h4>", unsafe_allow_html=True)
        ...
        <div style="background-color: #FFFFFF; padding: 20px; border-radius: 4px; border: 1px solid #E2E2E6; margin-top: 15px; border-left: 5px solid #76933C;">
            <h5 style="color: #252526; margin-top: 0; font-weight: 700; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">🎯 Нормативы для достижения прибыли {target_profit_fp:,.0f} ₽/мес:</h5>
    ...
    with st.expander("🚨 АНАЛИЗ И ВЫЯВЛЕНИЕ КРИТИЧЕСКОЙ ОШИБКИ В ИСХОДНОМ ЛИСТЕ «Лист1» (ФИДБЕК БРОКЕРУ)"):
        st.markdown(f"""
        <div style="background-color: #FFF2CC; padding: 25px; border-left: 5px solid #F0C13A; border-radius: 4px; color: #252526;">
            ...
            <hr style="border-top: 1px solid #D9C193; margin: 15px 0;">
            <h5 style="color: #252526 !important; font-weight: 700; margin: 10px 0;">Сравнение показателей при целевой прибыли {target_profit_fp:,.0f} ₽:</h5>
        </div>
        """, unsafe_allow_html=True)
    ...
    st.markdown("""
    <div style="background-color: #252526; padding: 25px 30px; border-left: 5px solid #BEAF87; border-radius: 4px; margin-bottom: 30px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
        <h1 style="color: #FFFFFF !important; margin: 0; font-size: 2.1rem; letter-spacing: 3px; font-weight: 700; font-family: 'Montserrat', sans-serif; text-transform: uppercase;">ОБРАТНОЕ ПЛАНИРОВАНИЕ ЦЕЛЕЙ</h1>
        <p style="color: #BEAF87; margin: 8px 0 0 0; font-size: 0.95rem; text-transform: uppercase; letter-spacing: 1.5px; font-weight: 600;">Установите желаемый доход, и система рассчитает нормативы активности агента по стандартам бренда</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with col_g1:
        st.markdown("<h4 style='color: #BEAF87 !important;'>1. Финансовые ориентиры</h4>", unsafe_allow_html=True)
        ...
        st.markdown("<h4 style='color: #BEAF87 !important;'>2. Ваши персональные конверсии</h4>", unsafe_allow_html=True)
    ...
    with col_g2:
        ...
        fig_agent_funnel = go.Figure(go.Funnel(
            ...
            x=values,
            textinfo="value",
            marker=dict(color=["#333333", "#BEAF87", "#D9C193", "#EAE0CE"])
        ))
    ...
    with col_save1:
        st.markdown("<h4 style='color: #BEAF87 !important;'>📥 Сохранить цель в архив офиса</h4>", unsafe_allow_html=True)
    ...
    with col_save2:
        st.markdown("<h4 style='color: #BEAF87 !important;'>🔒 Панель Брокера: Личный архив целей</h4>", unsafe_allow_html=True)
        ...
        if broker_password == "c21":
            ...
            if len(st.session_state['agent_goals']) == 0:
                ...
                fig_goals_bar = go.Figure(go.Indicator(
                    ...
                    domain = {'x': [0, 1], 'y': [0, 1]},
                    title = {'text': "Совокупные финансовые амбиции команды (чистый доход, руб.)", 'font': {'size': 12, 'color': '#252526'}},
                    gauge = {
                        'axis': {'range': [None, scale_max], 'tickwidth': 1, 'tickcolor': "#252526"},
                        'bar': {'color': "#BEAF87"},
                        'bgcolor': "white",
                        'borderwidth': 2,
                        'bordercolor': "#EAEAEA",
    ...
    st.markdown("""
    <div style="background-color: #252526; padding: 25px 30px; border-left: 5px solid #BEAF87; border-radius: 4px; margin-bottom: 30px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
        <h1 style="color: #FFFFFF !important; margin: 0; font-size: 2.1rem; letter-spacing: 3px; font-weight: 700; font-family: 'Montserrat', sans-serif; text-transform: uppercase;">UNIT-ЭКОНОМИКА СДЕЛКИ</h1>
        <p style="color: #BEAF87; margin: 8px 0 0 0; font-size: 0.95rem; text-transform: uppercase; letter-spacing: 1.5px; font-weight: 600;">Детальный расчет рентабельности отдельной транзакции с учетом роялти бренда (6%), налогов и KPI выплат</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with col_dc1:
        st.markdown("<h4 style='color: #BEAF87 !important;'>📥 Параметры сделки</h4>", unsafe_allow_html=True)
    ...
    with col_dc2:
        st.markdown("<h4 style='color: #BEAF87 !important;'>📊 Расчет доходности и распределение</h4>", unsafe_allow_html=True)
        ...
        fig_pie = go.Figure(data=[go.Pie(
            ...
            values=clean_values,
            hole=.4,
            marker=dict(colors=['#BEAF87', '#D9C193', '#252526', '#555555', '#EAE0CE', '#76933C'])
        )])
...
elif menu == "🗺️ Пошаговый онбординг франчайзи":
    st.markdown("""
    <div style="background-color: #252526; padding: 25px 30px; border-left: 5px solid #BEAF87; border-radius: 4px; margin-bottom: 30px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
        <h1 style="color: #FFFFFF !important; margin: 0; font-size: 2.1rem; letter-spacing: 3px; font-weight: 700; font-family: 'Montserrat', sans-serif; text-transform: uppercase;">🗺️ Интерактивный онбординг франчайзи</h1>
        <p style="color: #BEAF87; margin: 8px 0 0 0; font-size: 0.95rem; text-transform: uppercase; letter-spacing: 1.5px; font-weight: 600;">Пошаговое интерактивное руководство по запуску франчайзи по стандартам бренда CENTURY 21</p>
    </div>
    """, unsafe_allow_html=True)
    
    st.markdown("---")
    
    # Global Milestones block
    st.markdown("### 📅 Глобальные временные ориентиры")
    col_t1, col_t2, col_t3 = st.columns(3)
    with col_t1:
        st.markdown("""
        <div style="background-color: #FFFFFF; padding: 20px; border-radius: 4px; border: 1px solid #E2E2E6; border-top: 4px solid #BEAF87; text-align: center; height: 180px;">
            <p style="margin: 0; color: #666666; font-size: 0.8rem; text-transform: uppercase; letter-spacing: 1px; font-weight: 700;">Развертывание и подготовка</p>
            <h2 style="margin: 10px 0; color: #BEAF87 !important; font-size: 1.8rem; font-weight: 800; font-family: 'Montserrat', sans-serif;">до 6 МЕСЯЦЕВ</h2>
            <p style="margin: 0; font-size: 0.85rem; color: #333333;">Подготовка к первым сделкам, настройка ИТ и обучение собственника и РОПа</p>
        </div>
        """, unsafe_allow_html=True)
    with col_t2:
        st.markdown("""
        <div style="background-color: #FFFFFF; padding: 20px; border-radius: 4px; border: 1px solid #E2E2E6; border-top: 4px solid #252526; text-align: center; height: 180px;">
            <p style="margin: 0; color: #666666; font-size: 0.8rem; text-transform: uppercase; letter-spacing: 1px; font-weight: 700;">Точка безубыточности</p>
            <h2 style="margin: 10px 0; color: #252526 !important; font-size: 1.8rem; font-weight: 800; font-family: 'Montserrat', sans-serif;">10 – 12 МЕСЯЦЕВ</h2>
            <p style="margin: 0; font-size: 0.85rem; color: #333333;">Выход офиса на операционный плюс (покрытие всех постоянных OpEx расходов)</p>
        </div>
        """, unsafe_allow_html=True)
    with col_t3:
        st.markdown("""
        <div style="background-color: #FFFFFF; padding: 20px; border-radius: 4px; border: 1px solid #E2E2E6; border-top: 4px solid #BEAF87; text-align: center; height: 180px;">
            <p style="margin: 0; color: #666666; font-size: 0.8rem; text-transform: uppercase; letter-spacing: 1px; font-weight: 700;">Окупаемость инвестиций (ROI)</p>
            <h2 style="margin: 10px 0; color: #BEAF87 !important; font-size: 1.8rem; font-weight: 800; font-family: 'Montserrat', sans-serif;">15 – 18 МЕСЯЦЕВ</h2>
            <p style="margin: 0; font-size: 0.85rem; color: #333333;">Полный возврат первоначальных инвестиций в открытие и развитие офиса</p>
        </div>
        """, unsafe_allow_html=True)
        
    st.markdown("---")
    
    # Initialize check states in streamlit
    if 'onb_checks' not in st.session_state:
        st.session_state['onb_checks'] = {
            "ch_1_1": True, "ch_1_2": True, "ch_1_3": True,
            "ch_2_1": True, "ch_2_2": False, "ch_2_3": False,
            "ch_3_1": True, "ch_3_2": False,
            "ch_4_1": False, "ch_4_2": False,
            "ch_5_1": False, "ch_5_2": False,
            "ch_6_1": False,
            "ch_7_1": False, "ch_7_2": False,
            "ch_8_1": False, "ch_8_2": False,
            "ch_9_1": False, "ch_9_2": False,
            "ch_10_1": False, "ch_10_2": False,
            "ch_11_1": False, "ch_11_2": False,
            "ch_12_1": False,
            "ch_13_1": False, "ch_13_2": False
        }
        
    # Count completion percentage based on checks
    total_checks = len(st.session_state['onb_checks'])
    completed_checks = sum(1 for v in st.session_state['onb_checks'].values() if v)
    completion_percentage = (completed_checks / total_checks) * 100.0
    
    col_bar, col_perc = st.columns([4, 1])
    with col_bar:
        st.markdown(f"**Общий прогресс развертывания франшизы CENTURY 21:**")
        st.progress(completion_percentage / 100.0)
    with col_perc:
        st.markdown(f"<h3 style='color: #BEAF87 !important; margin: 5px 0 0 0; text-align: right;'>{completion_percentage:.1f}%</h3>", unsafe_allow_html=True)
        
    st.markdown("---")
    
    # Tabs for Phases
    tab_p1, tab_p2, tab_p3 = st.tabs([
        "📁 Фаза I: Инфраструктура (Шаги 1–5)",
        "👥 Фаза II: Команда & Интеграция (Шаги 6–9)",
        "🚀 Фаза III: Запуск & Контроль (Шаги 10–13)"
    ])
    
    with tab_p1:
        st.markdown("""
        <div style="padding: 15px; background-color: #FFFFFF; border-radius: 4px; margin-bottom: 25px; border-left: 5px solid #BEAF87; border: 1px solid #E2E2E6; border-left: 5px solid #BEAF87;">
            <b style="color: #252526;">ФОКУС ЭТАПА:</b> Юридическое оформление, поиск локации, брендинг и техническая подготовка рабочего пространства.
        </div>
        """, unsafe_allow_html=True)
        
        # Step 1
        with st.expander("Шаг 1. Юридический контур и финансовая архитектура (Неделя 1)"):
            st.markdown("**Что на этом этапе понадобится:**")
            st.markdown("- Подписание сублицензионного договора и фиксация условий ступенчатого входа по роялти.")
            st.markdown("- Регистрация в системе отчетности **Онлайн Офис (21online.ru)** для фиксации будущих транзакций и расчета роялти.")
            st.info("ℹ️ *Справочно:* Отчетный период по сделкам — строго с 1-го по последнее число месяца.")
            
            st.session_state['onb_checks']['ch_1_1'] = st.checkbox("Подписан сублицензионный договор с УК", value=st.session_state['onb_checks']['ch_1_1'], key="c11")
            st.session_state['onb_checks']['ch_1_2'] = st.checkbox("Открыты расчетные счета компании", value=st.session_state['onb_checks']['ch_1_2'], key="c12")
            st.session_state['onb_checks']['ch_1_3'] = st.checkbox("Зарегистрирован кабинет в Онлайн Офисе (21online.ru)", value=st.session_state['onb_checks']['ch_1_3'], key="c13")
            
        # Step 2
        with st.expander("Шаг 2. Подбор и аренда офиса (Недели 1–2)"):
            st.markdown("**Что на этом этапе понадобится:**")
            st.markdown("- Выбор локации (учет трафика и позиционирования).")
            st.markdown("- Для полноценного офиса: площадь **не менее 70 кв. м**.")
            st.markdown("- Вариант *«Бутик-офис»*: площадь до 150 кв. м в локациях с высокой проходимостью (витрина объектов, консультации, без проведения сделок).")
            
            st.session_state['onb_checks']['ch_2_1'] = st.checkbox("Проведен аудит трафика потенциальных локаций", value=st.session_state['onb_checks']['ch_2_1'], key="c21")
            st.session_state['onb_checks']['ch_2_2'] = st.checkbox("Помещение арендовано (площадь соответствует стандарту)", value=st.session_state['onb_checks']['ch_2_2'], key="c22")
            st.session_state['onb_checks']['ch_2_3'] = st.checkbox("Договор аренды юридически согласован", value=st.session_state['onb_checks']['ch_2_3'], key="c23")
            
        # Step 3
        with st.expander("Шаг 3. Брендинг и стандарты оформления (Недели 2–3)"):
            st.markdown("**Что на этом этапе понадобится:**")
            st.markdown("- Реализация требований официального брендбука.")
            st.markdown("- Использование регламентированных цветов: *Relentless Gold*, *Obsessed Grey*, *White*, *PMS 2324* и правил верстки логотипа CENTURY 21.")
            st.markdown("- Размещение обязательной информационной вывески: **«Каждый офис находится в независимом владении и управлении»**.")
            
            st.session_state['onb_checks']['ch_3_1'] = st.checkbox("Ремонт офиса приведен в соответствие с цветами брендбука (золотой, серый, белый)", value=st.session_state['onb_checks']['ch_3_1'], key="c31")
            st.session_state['onb_checks']['ch_3_2'] = st.checkbox("Установлена вывеска с обязательным дисклеймером о независимом владении", value=st.session_state['onb_checks']['ch_3_2'], key="c32")
            
        # Step 4
        with st.expander("Шаг 4. ИТ-инфраструктура и оборудование рабочих мест (Недели 3–4)"):
            st.markdown("**Что на этом этапе понадобится:**")
            st.markdown("Закупка оборудования под минимальные технические требования:")
            st.markdown("- Процессор не ниже **Intel i3**, оперативная память от **4 GB**.")
            st.markdown("- Разрешение экрана от **1366x768**, скорость интернет-соединения от **5 Мб/сек**.")
            
            st.session_state['onb_checks']['ch_4_1'] = st.checkbox("Закуплены компьютеры и оргтехника по техническим спецификациям (>= Intel i3, 4GB)", value=st.session_state['onb_checks']['ch_4_1'], key="c41")
            st.session_state['onb_checks']['ch_4_2'] = st.checkbox("Подключен стабильный скоростной интернет (от 5 Мб/сек)", value=st.session_state['onb_checks']['ch_4_2'], key="c42")
            
        # Step 5
        with st.expander("Шаг 5. Активация базовых цифровых сервисов (Неделя 4)"):
            st.markdown("**Что на этом этапе понадобится:**")
            st.markdown("- Получение доступа к основной CRM-системе **topnlab.ru** (управление объектами, клиентами, выгрузка в рекламу, новостная лента).")
            st.markdown("- Настройка дополнительной CRM **21online.century21.ru** (управление агентами на сайте century21.ru, корпоративная почта, заказ выписок ЕГРН).")
            
            st.session_state['onb_checks']['ch_5_1'] = st.checkbox("Получен и настроен доступ к CRM-системе topnlab.ru", value=st.session_state['onb_checks']['ch_5_1'], key="c51")
            st.session_state['onb_checks']['ch_5_2'] = st.checkbox("Активирована CRM 21online.century21.ru и корпоративные почты", value=st.session_state['onb_checks']['ch_5_2'], key="c52")

    with tab_p2:
        st.markdown("""
        <div style="padding: 15px; background-color: #FFFFFF; border-radius: 4px; margin-bottom: 25px; border-left: 5px solid #BEAF87; border: 1px solid #E2E2E6;">
            <b style="color: #252526;">ФОКУС ЭТАПА:</b> Обучение собственника, запуск найма, подключение РОПа и интеграция в экосистему УК.
        </div>
        """, unsafe_allow_html=True)
        
        # Step 6
        with st.expander("Шаг 6. Проведение Upgrade-обучения собственника (Неделя 5)"):
            st.markdown("**Что на этом этапе понадобится:**")
            st.markdown("- Участие в специализированной программе для руководителей агентств — **IMA (International Management Academy)** с получением сертификата международного образца.")
            
            st.session_state['onb_checks']['ch_6_1'] = st.checkbox("Собственник прошел программу IMA в Бизнес-Академии C21", value=st.session_state['onb_checks']['ch_6_1'], key="c61")
            
        # Step 7
        with st.expander("Шаг 7. Найм HR-менеджера (Недели 5–6)"):
            st.markdown("**Что на этом этапе понадобится:**")
            st.markdown("- Размещение вакансий по стандартам и профилю бренда.")
            st.markdown("- Запуск воронки найма по стандартам CENTURY 21 для формирования потока стажеров и опытных агентов.")
            
            st.session_state['onb_checks']['ch_7_1'] = st.checkbox("Опубликован профиль вакансии HR-менеджера", value=st.session_state['onb_checks']['ch_7_1'], key="c71")
            st.session_state['onb_checks']['ch_7_2'] = st.checkbox("HR-менеджер нанят и оформлен в штат", value=st.session_state['onb_checks']['ch_7_2'], key="c72")
            
        # Step 8
        with st.expander("Шаг 8. Найм и интеграция РОПа (Недели 5–6)"):
            st.markdown("**Что на этом этапе понадобится:**")
            st.markdown("- Наем Руководителя отдела продаж.")
            st.markdown("- Внедрение регламентов контроля брокеров, настройки системы отчетности и ежедневных планерок.")
            
            st.session_state['onb_checks']['ch_8_1'] = st.checkbox("РОП успешно нанят в агентство", value=st.session_state['onb_checks']['ch_8_1'], key="c81")
            st.session_state['onb_checks']['ch_8_2'] = st.checkbox("РОП интегрирован в систему планерок и отчетности", value=st.session_state['onb_checks']['ch_8_2'], key="c82")
            
        # Step 9
        with st.expander("Шаг 9. Подключение к глобальным ресурсам сети (Неделя 6)"):
            st.markdown("**Что на этом этапе понадобится:**")
            st.markdown("- Интеграция с международной базой объектов **century21global.com**.")
            st.markdown("- Настройка доступа к базе собственников **Smart agent** и конструктору маркетинговых материалов в 21online.")
            
            st.session_state['onb_checks']['ch_9_1'] = st.checkbox("Настроена интеграция с международной базой объектов century21global.com", value=st.session_state['onb_checks']['ch_9_1'], key="c91")
            st.session_state['onb_checks']['ch_9_2'] = st.checkbox("Получен доступ к базе Smart agent и конструктору макетов Promotional", value=st.session_state['onb_checks']['ch_9_2'], key="c92")

    with tab_p3:
        st.markdown("""
        <div style="padding: 15px; background-color: #FFFFFF; border-radius: 4px; margin-bottom: 25px; border-left: 5px solid #BEAF87; border: 1px solid #E2E2E6;">
            <b style="color: #252526;">ФОКУС ЭТАПА:</b> Старт работы с лидами, адаптация первой волны агентов, внедрение KPI контроля и выход на окупаемость.
        </div>
        """, unsafe_allow_html=True)
        
        # Step 10
        with st.expander("Шаг 10. Адаптация стажеров и «Час звонка» (Недели 7–8)"):
            st.markdown("**Что на этом этапе понадобится:**")
            st.markdown("- Прохождение агентами программ обучения Бизнес-академии CENTURY 21 (**ORIENTATION 21**, **CREATE 21**).")
            st.markdown("- Внедрение ежедневных блоков холодных и теплых звонков по базе собственников с разбором типичных возражений.")
            
            st.session_state['onb_checks']['ch_10_1'] = st.checkbox("Стажеры зарегистрированы на курсы ORIENTATION 21 и CREATE 21", value=st.session_state['onb_checks']['ch_10_1'], key="c101")
            st.session_state['onb_checks']['ch_10_2'] = st.checkbox("Внедрен ежедневный блок холодных/теплых звонков ('Час звонка')", value=st.session_state['onb_checks']['ch_10_2'], key="c102")
            
        # Step 11
        with st.expander("Шаг 11. Внедрение системы регулярного планирования (Неделя 8+)"):
            st.markdown("**Что на этом этапе понадобится:**")
            st.markdown("- Фиксация ключевых показателей (KPI) для брокеров: количество звонков, назначенных встреч, эксклюзивных договоров и задатков.")
            
            st.session_state['onb_checks']['ch_11_1'] = st.checkbox("Утверждены плановые KPI для всех агентов офиса", value=st.session_state['onb_checks']['ch_11_1'], key="c111")
            st.session_state['onb_checks']['ch_11_2'] = st.checkbox("Внедрены ежедневные листы учета активности агентов", value=st.session_state['onb_checks']['ch_11_2'], key="c112")
            
        # Step 12
        with st.expander("Шаг 12. Установка HR-метрик и контроля закрепляемости (Недели 8–12)"):
            st.markdown("**Что на этом этапе понадобится:**")
            st.markdown("- Мониторинг конверсии воронки адаптации новичков (оценка эффективности прохождения обучающих курсов и выхода на первую сделку).")
            
            st.session_state['onb_checks']['ch_12_1'] = st.checkbox("Внедрен ежемесячный мониторинг конверсии воронки адаптации новичков", value=st.session_state['onb_checks']['ch_12_1'], key="c121")
            
        # Step 13
        with st.expander("Шаг 13. Регулярные цикличные встречи с куратором УК (Постоянно)"):
            st.markdown("**Что на этом этапе понадобится:**")
            st.markdown("- Аудит финансовых показателей, контроль своевременной отчетности в Онлайн Офисе.")
            st.markdown("- Контроль соблюдения стандартов бренда (включая использование фирстиля в соцсетях и рекламных макетах).")
            
            st.session_state['onb_checks']['ch_13_1'] = st.checkbox("Организован регулярный цикл встреч с куратором Управляющей компании", value=st.session_state['onb_checks']['ch_13_1'], key="c131")
            st.session_state['onb_checks']['ch_13_2'] = st.checkbox("Проведен аудит соблюдения фирменного стиля во всех соцсетях офиса", value=st.session_state['onb_checks']['ch_13_2'], key="c132")

    # Rerun logic to update total progress dynamically
    if st.button("🔄 Рассчитать общий прогресс онбординга"):
        st.success("Прогресс успешно пересчитан!")
        st.rerun()

elif menu == "🎓 Центр обучения & Адаптации":
    st.markdown("""
    <div style="background-color: #252526; padding: 25px 30px; border-left: 5px solid #BEAF87; border-radius: 4px; margin-bottom: 30px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
        <h1 style="color: #FFFFFF !important; margin: 0; font-size: 2.1rem; letter-spacing: 3px; font-weight: 700; font-family: 'Montserrat', sans-serif; text-transform: uppercase;">АКАДЕМИЯ АДАПТАЦИИ "ПЕРВЫЕ 90 ДНЕЙ"</h1>
        <p style="color: #BEAF87; margin: 8px 0 0 0; font-size: 0.95rem; text-transform: uppercase; letter-spacing: 1.5px; font-weight: 600;">Интегрированный хаб знаний: электронный трекер, экспресс-тестирование, тренажер возражений и медиатека</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with tab_cards:
        ...
        if "Я продам сам" in card:
            ...
            <div style="background-color: #FFF2CC; padding: 20px; border-left: 5px solid #F0C13A; border-radius: 4px;">
                ...
                <p style="margin: 10px 0 0 0; font-style: italic; color: #252526;">
...
# ==============================================================================
    ...
    st.markdown("""
    <div style="background-color: #252526; padding: 25px 30px; border-left: 5px solid #BEAF87; border-radius: 4px; margin-bottom: 30px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
        <h1 style="color: #FFFFFF !important; margin: 0; font-size: 2.1rem; letter-spacing: 3px; font-weight: 700; font-family: 'Montserrat', sans-serif; text-transform: uppercase;">🏃 СТАНДАРТЫ АДАПТАЦИИ & КОНВЕЙЕР ЛИДОВ</h1>
        <p style="color: #BEAF87; margin: 8px 0 0 0; font-size: 0.95rem; text-transform: uppercase; letter-spacing: 1.5px; font-weight: 600;">Интегрированные стандарты стажировки РОПа, нормативов стажеров и конвейерной работы с покупателями</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with tab_audit:
        ...
        with col_aud1:
            st.markdown("""
            <div style="background-color: #FFFFFF; padding: 20px; border-left: 4px solid #BEAF87; border-radius: 4px; box-shadow: 0 4px 10px rgba(0,0,0,0.02); margin-bottom: 15px;">
                <h4 style="color: #252526; margin-top: 0; font-size: 1.1rem; text-transform: uppercase; letter-spacing: 1px;">💪 Сильные стороны регламентов:</h4>
        ...
        with col_aud2:
            st.markdown("""
            <div style="background-color: #FFFFFF; padding: 20px; border-left: 4px solid #252526; border-radius: 4px; box-shadow: 0 4px 10px rgba(0,0,0,0.02); margin-bottom: 15px;">
                <h4 style="color: #252526; margin-top: 0; font-size: 1.1rem; text-transform: uppercase; letter-spacing: 1px;">⚠️ Выявленные слабости и точки роста:</h4>
                <p style="font-size: 0.9rem; line-height: 1.5; color: #222222;">
    ...
    with tab_rop:
        ...
        if "День 1" in rop_day:
            ...
            <div style="background-color: #FFFFFF; padding: 20px; border-radius: 4px; border: 1px solid #E2E2E6;">
                <h4 style="color: #BEAF87;">🎯 Задачи 1-го дня: Знакомство и старт CREATE 21</h4>
                <ul>
            ...
            st.markdown("""
            <div style="background-color: #FFFFFF; padding: 20px; border-radius: 4px; border: 1px solid #E2E2E6;">
                <h4 style="color: #BEAF87;">🎯 Задачи 2-го дня: Отработка скриптов и коммуникация</h4>
                <ul>
            ...
            st.markdown("""
            <div style="background-color: #FFFFFF; padding: 20px; border-radius: 4px; border: 1px solid #E2E2E6;">
                <h4 style="color: #BEAF87;">🎯 Задачи 3-го дня: CRM-системы и бизнес-планирование</h4>
                <ul>
            ...
            st.markdown("""
            <div style="background-color: #FFFFFF; padding: 20px; border-radius: 4px; border: 1px solid #E2E2E6;">
                <h4 style="color: #BEAF87;">🎯 Задачи 4-го дня: Тестирование и Анализ концепции</h4>
                <ul>
            ...
            st.markdown("""
            <div style="background-color: #FFFFFF; padding: 20px; border-radius: 4px; border: 1px solid #E2E2E6;">
                <h4 style="color: #BEAF87;">🎯 Задачи 5-го дня: Разработка Стратегического плана развития</h4>
                <ul>
        ...
        with col_sta2:
            ...
            if failed_intervals >= 2 and not is_valid:
                ...
                <div style="background-color: #FCE4D6; padding: 20px; border-left: 5px solid #C65911; border-radius: 4px;">
                    ...
                    <p style="margin: 0; font-size: 0.9rem; line-height: 1.4; color: #252526;">
    ...
    with tab_buyer_conveyor:
        ...
        with col_co1:
            st.markdown("<h4 style='color: #BEAF87 !important;'>📥 Входящий трафик (Колл-центр)</h4>", unsafe_allow_html=True)
        ...
        with col_co2:
            st.markdown("<h4 style='color: #BEAF87 !important;'>💰 Экономический эффект специализации</h4>", unsafe_allow_html=True)
            ...
            <div style="background-color: #FFFFFF; padding: 20px; border-radius: 4px; border: 1px solid #E2E2E6; margin-bottom: 20px;">
                <h5 style="color: #252526; margin-top: 0; text-transform: uppercase;">Расчет упущенной прибыли от простоя лидов:</h5>
                ...
                <h3 style="color: #BEAF87 !important; margin: 0; font-size: 1.6rem;">💵 УПУЩЕННЫЙ ВКД: {captured_gci:,.0f} ₽</h3>
            ...
            <div style="background-color: #E2EFDA; padding: 20px; border-radius: 4px; border-left: 5px solid #375623;">
                ...
                <p style="margin: 0; font-size: 0.9rem; line-height: 1.5; color: #252526;">
    ...
    st.markdown("""
    <div style="background-color: #252526; padding: 25px 30px; border-left: 5px solid #BEAF87; border-radius: 4px; margin-bottom: 30px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
        <h1 style="color: #FFFFFF !important; margin: 0; font-size: 2.1rem; letter-spacing: 3px; font-weight: 700; font-family: 'Montserrat', sans-serif; text-transform: uppercase;">🤖 ИИ-Консультант CENTURY 21</h1>
        <p style="color: #BEAF87; margin: 8px 0 0 0; font-size: 0.95rem; text-transform: uppercase; letter-spacing: 1.5px; font-weight: 600;">Интерактивный ИИ-ассистент по Книге брокера, Книги агента и регламентам бренда</p>
    </div>
    """, unsafe_allow_html=True)
...
# =============================================================================
    ...
    st.markdown("""
    <div style="background-color: #252526; padding: 25px 30px; border-left: 5px solid #BEAF87; border-radius: 4px; margin-bottom: 30px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
        <h1 style="color: #FFFFFF !important; margin: 0; font-size: 2.1rem; letter-spacing: 3px; font-weight: 700; font-family: 'Montserrat', sans-serif; text-transform: uppercase;">🌐 СЕРВИСЫ & ЭКОСИСТЕМА C21</h1>
        <p style="color: #BEAF87; margin: 8px 0 0 0; font-size: 0.95rem; text-transform: uppercase; letter-spacing: 1.5px; font-weight: 600;">Интерактивный навигатор по всем 23 официальным сервисам и технологиям CENTURY 21 Россия для франчайзи</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div style="background-color: #FFFFFF; padding: 25px; border-radius: 4px; border: 1px solid #E2E2E6; margin-bottom: 30px;">
        <h3 style="color: #252526; margin-top: 0; margin-bottom: 15px; font-size: 1.4rem; text-transform: uppercase; letter-spacing: 1px;">📊 Аудит источника «Сервисы C21»</h3>
    ...
    with tab_it:
        ...
        with col_it1:
            ...
            <div class='c21-card' style='padding: 15px; border: 1px solid #E2E2E6; margin-bottom: 15px;'>
                <h5 style='color:#BEAF87; margin-top:0;'>1. Основная CRM topnlab.ru</h5>
            ...
            <div class='c21-card' style='padding: 15px; border: 1px solid #E2E2E6; margin-bottom: 15px; margin-top: 20px;'>
                <h5 style='color:#BEAF87; margin-top:0;'>2. Личный кабинет 21online.century21.ru</h5>
                <p style='font-size:0.85rem; color:#444; line-height:1.4; margin-bottom:10px;'>
            ...
            st.markdown("""
            <div class='c21-card' style='padding: 15px; border: 1px solid #E2E2E6; margin-bottom: 15px; margin-top: 20px;'>
                <h5 style='color:#BEAF87; margin-top:0;'>3. Корпоративный сайт century21.ru</h5>
                <p style='font-size:0.85rem; color:#444; line-height:1.4; margin-bottom:10px;'>
        ...
        with col_it2:
            st.markdown("""
            <div class='c21-card' style='padding: 15px; border: 1px solid #E2E2E6; margin-bottom: 15px;'>
                <h5 style='color:#BEAF87; margin-top:0;'>4. Мобильная и Офисная IP-Телефония</h5>
                <p style='font-size:0.85rem; color:#444; line-height:1.4; margin-bottom:10px;'>
            ...
            st.markdown("""
            <div class='c21-card' style='padding: 15px; border: 1px solid #E2E2E6; margin-bottom: 15px; margin-top: 20px;'>
                <h5 style='color:#BEAF87; margin-top:0;'>5. Технологии Яндекса и Почта</h5>
                <p style='font-size:0.85rem; color:#444; line-height:1.4; margin-bottom:10px;'>
    ...
    with tab_edu:
        ...
        with col_ed1:
            st.markdown("""
            <div class='c21-card' style='padding: 15px; border: 1px solid #E2E2E6; margin-bottom: 15px;'>
                <h5 style='color:#BEAF87; margin-top:0;'>1. Портал обучения edu.century21.ru</h5>
                <p style='font-size:0.85rem; color:#444; line-height:1.4; margin-bottom:10px;'>
            ...
            st.markdown("""
            <div class='c21-card' style='padding: 15px; border: 1px solid #E2E2E6; margin-bottom: 15px; margin-top: 20px;'>
                <h5 style='color:#BEAF87; margin-top:0;'>2. Программа IMA для Руководителей</h5>
                <p style='font-size:0.85rem; color:#444; line-height:1.4; margin-bottom:10px;'>
        ...
        with col_ed2:
            st.markdown("""
            <div class='c21-card' style='padding: 15px; border: 1px solid #E2E2E6; margin-bottom: 15px;'>
                <h5 style='color:#BEAF87; margin-top:0;'>3. Выезд Бизнес-тренера в офис</h5>
                <p style='font-size:0.85rem; color:#444; line-height:1.4; margin-bottom:10px;'>
            ...
            st.markdown("""
            <div class='c21-card' style='padding: 15px; border: 1px solid #E2E2E6; margin-bottom: 15px; margin-top: 20px;'>
                <h5 style='color:#BEAF87; margin-top:0;'>4. Настольные Книги CENTURY 21</h5>
                <p style='font-size:0.85rem; color:#444; line-height:1.4; margin-bottom:10px;'>
    ...
    with tab_mkt:
        ...
        with col_m1:
            st.markdown("""
            <div class='c21-card' style='padding: 15px; border: 1px solid #E2E2E6; margin-bottom: 15px;'>
                <h5 style='color:#BEAF87; margin-top:0;'>1. Конструктор макетов Promotional</h5>
                <p style='font-size:0.85rem; color:#444; line-height:1.4; margin-bottom:10px;'>
            ...
            st.markdown("""
            <div class='c21-card' style='padding: 15px; border: 1px solid #E2E2E6; margin-bottom: 15px; margin-top: 20px;'>
                <h5 style='color:#BEAF87; margin-top:0;'>2. Интернет-магазин shop.century21.ru</h5>
                <p style='font-size:0.85rem; color:#444; line-height:1.4; margin-bottom:10px;'>
            ...
            st.markdown("""
            <div class='c21-card' style='padding: 15px; border: 1px solid #E2E2E6; margin-bottom: 15px; margin-top: 20px;'>
                <h5 style='color:#BEAF87; margin-top:0;'>3. Журнал CENTURY 21 Magazine</h5>
                <p style='font-size:0.85rem; color:#444; line-height:1.4; margin-bottom:10px;'>
            ...
            st.markdown("""
            <div class='c21-card' style='padding: 15px; border: 1px solid #E2E2E6; margin-bottom: 15px; margin-top: 20px;'>
                <h5 style='color:#BEAF87; margin-top:0;'>4. Канал Яндекс.Дзен C21</h5>
                <p style='font-size:0.85rem; color:#444; line-height:1.4; margin-bottom:10px;'>
        ...
        with col_m2:
            st.markdown("""
            <div class='c21-card' style='padding: 15px; border: 1px solid #E2E2E6; margin-bottom: 15px;'>
                <h5 style='color:#BEAF87; margin-top:0;'>5. Рекламные лендинги услуг</h5>
                <p style='font-size:0.85rem; color:#444; line-height:1.4; margin-bottom:10px;'>
            ...
            st.markdown("""
            <div class='c21-card' style='padding: 15px; border: 1px solid #E2E2E6; margin-bottom: 15px; margin-top: 20px;'>
                <h5 style='color:#BEAF87; margin-top:0;'>6. Контакт-центр 24/7</h5>
                <p style='font-size:0.85rem; color:#444; line-height:1.4; margin-bottom:10px;'>
            ...
            st.markdown("""
            <div class='c21-card' style='padding: 15px; border: 1px solid #E2E2E6; margin-bottom: 15px; margin-top: 20px;'>
                <h5 style='color:#BEAF87; margin-top:0;'>7. Промо-ролики бренда</h5>
                <p style='font-size:0.85rem; color:#444; line-height:1.4; margin-bottom:10px;'>
            ...
            st.markdown("""
            <div class='c21-card' style='padding: 15px; border: 1px solid #E2E2E6; margin-bottom: 15px; margin-top: 20px;'>
                <h5 style='color:#BEAF87; margin-top:0;'>8. Консалтинг по продвижению и PR</h5>
                <p style='font-size:0.85rem; color:#444; line-height:1.4; margin-bottom:10px;'>
    ...
    with tab_hr:
        ...
        with col_hr1:
            st.markdown("""
            <div class='c21-card' style='padding: 15px; border: 1px solid #E2E2E6; margin-bottom: 15px;'>
                <h5 style='color:#BEAF87; margin-top:0;'>1. Страхование профессиональной ответственности</h5>
                <p style='font-size:0.85rem; color:#444; line-height:1.4; margin-bottom:10px;'>
            ...
            st.markdown("""
            <div class='c21-card' style='padding: 15px; border: 1px solid #E2E2E6; margin-bottom: 15px; margin-top: 20px;'>
                <h5 style='color:#BEAF87; margin-top:0;'>2. Корпоративный доступ к HeadHunter (HH.ru)</h5>
                <p style='font-size:0.85rem; color:#444; line-height:1.4; margin-bottom:10px;'>
        ...
        with col_hr2:
            st.markdown("""
            <div class='c21-card' style='padding: 15px; border: 1px solid #E2E2E6; margin-bottom: 15px;'>
                <h5 style='color:#BEAF87; margin-top:0;'>3. Черный список агентов РФ</h5>
                <p style='font-size:0.85rem; color:#444; line-height:1.4; margin-bottom:10px;'>
            ...
            st.markdown("""
            <div class='c21-card' style='padding: 15px; border: 1px solid #E2E2E6; margin-bottom: 15px; margin-top: 20px;'>
                <h5 style='color:#BEAF87; margin-top:0;'>4. HR-консалтинг и коучинг партнеров</h5>
                <p style='font-size:0.85rem; color:#444; line-height:1.4; margin-bottom:10px;'>
    ...
    with tab_support:
        ...
        with col_s1:
            st.markdown("""
            <div class='c21-card' style='padding: 15px; border: 1px solid #E2E2E6; margin-bottom: 15px;'>
                <h5 style='color:#BEAF87; margin-top:0;'>1. Единый контакт Службы Заботы УК</h5>
                <p style='font-size:0.85rem; color:#444; line-height:1.4; margin-bottom:10px;'>
        ...
        with col_s2:
            st.markdown("""
            <div class='c21-card' style='padding: 15px; border: 1px solid #E2E2E6; margin-bottom: 15px;'>
                <h5 style='color:#BEAF87; margin-top:0;'>2. Профильная система WhatsApp-чатов</h5>
                <p style='font-size:0.85rem; color:#444; line-height:1.4; margin-bottom:10px;'>
...
# ==============================================================================
# MODULE: BRANDBOOK & DESIGN SYSTEM (🎨 Брендбук & Дизайн-система)
# ==============================================================================
elif menu == "🎨 Брендбук & Дизайн-система":
    st.markdown("""
    <div style="background-color: #252526; padding: 25px 30px; border-left: 5px solid #BEAF87; border-radius: 4px; margin-bottom: 30px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
        <h1 style="color: #FFFFFF !important; margin: 0; font-size: 2.1rem; letter-spacing: 3px; font-weight: 700; font-family: 'Montserrat', sans-serif; text-transform: uppercase;">🎨 БРЕНДБУК & ДИЗАЙН-СИСТЕМА</h1>
        <p style="color: #BEAF87; margin: 8px 0 0 0; font-size: 0.95rem; text-transform: uppercase; letter-spacing: 1.5px; font-weight: 600;">Официальные визуальные элементы, стандарты оформления и SWOT-анализ брендбука CENTURY 21 Россия</p>
    </div>
    """, unsafe_allow_html=True)
    
    st.markdown("---")
    
    tab_swot, tab_palette, tab_rules = st.tabs([
        "📊 SWOT-Анализ & Решения",
        "🎨 Интерактивная палитра & Темизация",
        "📐 Стандарты логотипа & Оформления"
    ])
    
    with tab_swot:
        st.markdown("""
        ### 📊 SWOT-Анализ официального BrandBook CENTURY 21 Россия
        Детальный экспертный аудит сильных и слабых сторон визуальной концепции бренда.
        """)
        
        col_s1, col_s2 = st.columns(2)
        with col_s1:
            st.markdown("""
            <div style="background-color: #FFFFFF; padding: 25px; border-radius: 4px; border: 1px solid #E2E2E6; border-left: 5px solid #76933C; margin-bottom: 20px;">
                <h4 style="color: #76933C; margin-top: 0; text-transform: uppercase; font-size: 1rem; font-weight: 800; letter-spacing: 1px;">💪 Сильные стороны (Strengths)</h4>
                <ul style="font-size: 0.95rem; line-height: 1.6; color: #333333; padding-left: 20px;">
                    <li><b>Премиальное позиционирование:</b> Использование сочетания Relentless Gold (#BEAF87) и Obsessed Grey (#252526) выделяет CENTURY 21 на фоне традиционных риелторских агентств, ассоциируясь с высоким качеством и надежностью [4].</li>
                    <li><b>Защита товарного знака:</b> Жесткое правило охранной зоны вокруг логотипа (минимум 1/2 высоты знака) предотвращает визуальный хаос и наложение посторонних элементов [2].</li>
                    <li><b>Целостность монограммы:</b> Строгие правила запрета на деформацию, прозрачность, обрезку монограммы C21 и раздельное использование цветов для буквенных элементов гарантируют 100% узнаваемость [3].</li>
                    <li><b>Типографика высокого стиля:</b> Премиальные шрифты Gilroy Extra Bold (заголовки) и Core Sans / DinPro (тексты) создают премиальный издательский облик всех маркетинговых материалов [4, 5].</li>
                </ul>
            </div>
            
            <div style="background-color: #FFFFFF; padding: 25px; border-radius: 4px; border: 1px solid #E2E2E6; border-left: 5px solid #C5A059; margin-bottom: 20px;">
                <h4 style="color: #C5A059; margin-top: 0; text-transform: uppercase; font-size: 1rem; font-weight: 800; letter-spacing: 1px;">💡 Возможности внедрения (Opportunities)</h4>
                <ul style="font-size: 0.95rem; line-height: 1.6; color: #333333; padding-left: 20px;">
                    <li><b>100% Оцифровка стиля:</b> Внедрение точных HEX-кодов брендбука во все элементы интерфейса ИТ-платформы (кнопки, графики, таблицы, дашборды) [4].</li>
                    <li><b>Динамическая темизация:</b> Возможность для франчайзи переключать оформление интерфейса между основной золотой и вторичной темной палитрой бренда [4].</li>
                    <li><b>Охранный ИИ-контроль:</b> Использование ИИ-ассистента для автоматической проверки соответствия загружаемых рекламных макетов правилам BrandBook.</li>
                </ul>
            </div>
            """, unsafe_allow_html=True)
        ...
        with col_s2:
            st.markdown("""
            <div style="background-color: #FFFFFF; padding: 25px; border-radius: 4px; border: 1px solid #E2E2E6; border-left: 5px solid #C65911; margin-bottom: 20px;">
                <h4 style="color: #C65911; margin-top: 0; text-transform: uppercase; font-size: 1rem; font-weight: 800; letter-spacing: 1px;">⚠️ Слабые стороны (Weaknesses)</h4>
                <ul style="font-size: 0.95rem; line-height: 1.6; color: #333333; padding-left: 20px;">
                    <li><b>Платные лицензии шрифтов:</b> Gilroy, Core Sans и DinPro являются коммерческими шрифтами, требующими покупки лицензий франчайзи [4, 5]. Это усложняет их веб-интеграцию без существенных вложений.</li>
                    <li><b>Дорогая полиграфия:</b> Печать фирменного золотого цвета (Relentless Gold) требует дорогостоящего использования металлизированного пантона (PMS 8383 C / PMS 2324), что удорожает производство POSM-материалов на местах [5].</li>
                    <li><b>Отсутствие цифровых стандартов:</b> Официальный BrandBook ориентирован преимущественно на печатную продукцию и наружную рекламу, не описывая стандарты адаптивного веб-дизайна (UI/UX мобильных приложений, дашбордов и личных кабинетов).</li>
                </ul>
            </div>
            
            <div style="background-color: #FFFFFF; padding: 25px; border-radius: 4px; border: 1px solid #E2E2E6; border-left: 5px solid #2F2F2F; margin-bottom: 20px;">
                <h4 style="color: #2F2F2F; margin-top: 0; text-transform: uppercase; font-size: 1rem; font-weight: 800; letter-spacing: 1px;">🎯 Угрозы и Риски (Threats)</h4>
                <ul style="font-size: 0.95rem; line-height: 1.6; color: #333333; padding-left: 20px;">
                    <li><b>Кустарный дизайн на местах:</b> Из-за сложности ручной сборки макетов франчайзи часто нарушают правила (используют не те шрифты, сужают логотипы, игнорируют охранное поле), подрывая премиальный имидж бренда [2, 3].</li>
                    <li><b>Размытие единой дизайн-системы:</b> Отсутствие у франчайзи единой цифровой ИТ-платформы ведет к созданию разношерстных сайтов и Лендингов, которые выглядят неэстетично и снижают доверие клиентов.</li>
                </ul>
            </div>
            """, unsafe_allow_html=True)
    ...
    with tab_palette:
        st.markdown("""
        ### 🎨 Корпоративная палитра & Темизация интерфейса
        В соответствии со стандартами BrandBook CENTURY 21 Россия, мы оцифровали основную и дополнительную палитры бренда [4].
        """)
        
        # Color Theme Switcher
        st.markdown("#### 🔧 Выберите акцентный цвет для вашего Личного кабинета:")
        col_th1, col_th2, col_th3 = st.columns(3)
        with col_th1:
            if st.button("🌟 RELENTLESS GOLD (Основной: #BEAF87)"):
                st.session_state['brand_gold'] = '#BEAF87'
                st.success("Палитра успешно переключена на Relentless Gold!")
                st.rerun()
        with col_th2:
            if st.button("🟫 DARK GOLD (Дополнительный: #A19276)"):
                st.session_state['brand_gold'] = '#A19276'
                st.success("Палитра успешно переключена на Dark Gold!")
                st.rerun()
        with col_th3:
            if st.button("💼 OBSESSED GREY (Сбросить до дефолта)"):
                st.session_state['brand_gold'] = '#BEAF87'
                st.session_state['brand_charcoal'] = '#252526'
                st.success("Цветовая схема сброшена к стандартным значениям!")
                st.rerun()
                
        # Interactive Color Swatches Display
        st.markdown("#### 📋 Фирменные цвета по паспорту стандартов:")
        col_c1, col_c2, col_c3 = st.columns(3)
        
        with col_c1:
            st.markdown("""
            <div style="background-color: #BEAF87; height: 120px; border-radius: 4px; display: flex; align-items: flex-end; padding: 15px; margin-bottom: 10px;">
                <span style="color: #FFFFFF; font-weight: 800; font-size: 1.1rem; text-shadow: 1px 1px 2px rgba(0,0,0,0.5);">RELENTLESS GOLD</span>
            </div>
            <div style="background-color: #FFFFFF; padding: 15px; border: 1px solid #E2E2E6; border-radius: 4px;">
                <p style="margin: 5px 0;">🎨 <b>HEX:</b> #BEAF87</p>
                <p style="margin: 5px 0;">📄 <b>PMS:</b> 2324 / Specialty 8383 C</p>
                <p style="margin: 5px 0;">🖨️ <b>CMYK:</b> C-22, M-22, Y-46, K-7</p>
                <p style="margin: 5px 0;">🖥️ <b>RGB:</b> 190, 175, 135</p>
            </div>
            """, unsafe_allow_html=True)
            
        with col_c2:
            st.markdown("""
            <div style="background-color: #252526; height: 120px; border-radius: 4px; display: flex; align-items: flex-end; padding: 15px; margin-bottom: 10px;">
                <span style="color: #FFFFFF; font-weight: 800; font-size: 1.1rem; text-shadow: 1px 1px 2px rgba(0,0,0,0.5);">OBSESSED GREY</span>
            </div>
            <div style="background-color: #FFFFFF; padding: 15px; border: 1px solid #E2E2E6; border-radius: 4px;">
                <p style="margin: 5px 0;">🎨 <b>HEX:</b> #252526</p>
                <p style="margin: 5px 0;">📄 <b>PMS:</b> Black 7</p>
                <p style="margin: 5px 0;">🖨️ <b>CMYK:</b> C-0, M-0, Y-0, K-90</p>
                <p style="margin: 5px 0;">🖥️ <b>RGB:</b> 37, 37, 38</p>
            </div>
            """, unsafe_allow_html=True)
            
        with col_c3:
            st.markdown("""
            <div style="background-color: #A19276; height: 120px; border-radius: 4px; display: flex; align-items: flex-end; padding: 15px; margin-bottom: 10px;">
                <span style="color: #FFFFFF; font-weight: 800; font-size: 1.1rem; text-shadow: 1px 1px 2px rgba(0,0,0,0.5);">DARK GOLD</span>
            </div>
            <div style="background-color: #FFFFFF; padding: 15px; border: 1px solid #E2E2E6; border-radius: 4px;">
                <p style="margin: 5px 0;">🎨 <b>HEX:</b> #A19276</p>
                <p style="margin: 5px 0;">📄 <b>PMS:</b> Дополнительный Gold</p>
                <p style="margin: 5px 0;">🖨️ <b>CMYK:</b> C-36, M-36, Y-56, K-6</p>
                <p style="margin: 5px 0;">🖥️ <b>RGB:</b> 161, 146, 118</p>
            </div>
            """, unsafe_allow_html=True)
            
    with tab_rules:
        st.markdown("""
        ### 📐 Стандарты логотипа, монограммы и наружного оформления
        Официальные правила размещения брендовых элементов, регламентированные Управляющей компанией.
        """)
        
        col_r1, col_s_r2 = st.columns(2)
        with col_r1:
            st.markdown("""
            <div style="background-color: #FFFFFF; padding: 25px; border-radius: 4px; border: 1px solid #E2E2E6; border-left: 5px solid #252526; margin-bottom: 20px;">
                <h4 style="color: #252526; margin-top: 0; text-transform: uppercase; font-size: 1rem; font-weight: 800; letter-spacing: 1px;">📐 Правила охранного поля Товарного Знака</h4>
                <p style="font-size: 0.95rem; line-height: 1.6; color: #555555;">
                    Логотип <b>CENTURY 21</b> должен всегда использоваться вместе с названием компании-сублицензиата в качестве обязательной части всех сообщений и материалов [1, 2].
                </p>
                <ul style="font-size: 0.92rem; line-height: 1.6; color: #333333; padding-left: 20px;">
                    <li><b>Охранное поле (Clean Space):</b> Свободное чистое пространство вокруг логотипа должно строго равняться <b>половине высоты (0.5X)</b> самого товарного знака [2].</li>
                    <li><b>Минимальный размер:</b> Длина логотипа на любых печатных носителях не должна быть менее <b>2.5 сантиметров</b> [1, 2].</li>
                    <li><b>Метка ®:</b> Высота знака зарегистрированной торговой марки должна быть строго равна высоте верхней части цифры 1 в логотипе [1, 2].</li>
                </ul>
            </div>
            """, unsafe_allow_html=True)
        ...
        with col_s_r2:
            st.markdown("""
            <div style="background-color: #FFFFFF; padding: 25px; border-radius: 4px; border: 1px solid #E2E2E6; border-left: 5px solid #BEAF87; margin-bottom: 20px;">
                <h4 style="color: #BEAF87; margin-top: 0; text-transform: uppercase; font-size: 1rem; font-weight: 800; letter-spacing: 1px;">🚫 Жесткие запреты (Brand Violations)</h4>
                <p style="font-size: 0.95rem; line-height: 1.6; color: #555555;">
                    Для сохранения целостности бренда Управляющая компания CENTURY 21 Россия категорически запрещает следующие действия [3]:
                </p>
                <ul style="font-size: 0.92rem; line-height: 1.6; color: #333333; padding-left: 20px;">
                    <li>❌ Использование монограммы C21 или Товарного Знака с прозрачностью (кроме официально утвержденных макетов водяных знаков) [3].</li>
                    <li>❌ Размещение любого стороннего текста или логотипов поверх Товарного Знака или Монограммы [3].</li>
                    <li>❌ Сливание Монограммы с Товарным Знаком или названием компании в один графический элемент [3].</li>
                    <li>❌ Применение разных цветов к символу «C» и цифрам «21» в Монограмме [3].</li>
                </ul>
            </div>
            """, unsafe_allow_html=True)
            
        st.markdown("""
        <div style="background-color: #FFFFFF; padding: 25px; border-radius: 4px; border: 1px solid #E2E2E6; margin-top: 10px;">
            <h4 style="color: #252526; margin-top: 0; text-transform: uppercase; font-size: 1.1rem; font-weight: 800; letter-spacing: 1px; text-align: center;">🏢 Наружные и корпоративные бренд-материалы</h4>
            <p style="font-size: 0.95rem; line-height: 1.6; color: #555555; text-align: center;">
                Все оригинальные рекламные исходники, чертежи оформления фасадов, визиток, бейджей и папок агентов доступны в единой Базе макетов УК [5, 6].
            </p>
            ...
            <div style="display: flex; justify-content: space-around; flex-wrap: wrap; gap: 15px;">
                <div style="text-align: center; flex: 1; min-width: 180px;">
                    ...
                    <p style="font-weight: 700; margin: 5px 0 0 0;">Оформление офиса</p>
                    <p style="font-size: 0.85rem; color: #666; margin: 0;">Вывеска, ресепшен, светящаяся карта, постеры [5]</p>
                </div>
                <div style="text-align: center; flex: 1; min-width: 180px;">
                    <p style="font-size: 1.5rem; margin: 0;">📇</p>
                    <p style="font-weight: 700; margin: 5px 0 0 0;">Бизнес-айдентика</p>
                    <p style="font-size: 0.85rem; color: #666; margin: 0;">Визитки, папки агента, бейджи, ленты [5, 6]</p>
                </div>
                <div style="text-align: center; flex: 1; min-width: 180px;">
                    <p style="font-size: 1.5rem; margin: 0;">🛍️</p>
                    <p style="font-weight: 700; margin: 5px 0 0 0;">Сувенирный магазин</p>
                    <p style="font-size: 0.85rem; color: #666; margin: 0;">Официальный магазин: <a href="https://shop.century21.ru" target="_blank">shop.century21.ru</a> [6]</p>
                </div>
            </div>
        </div>
        """, unsafe_allow_html=True)
    ...
    st.markdown("""
    <div style="background-color: #252526; padding: 25px 30px; border-left: 5px solid #BEAF87; border-radius: 4px; margin-bottom: 30px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
        <h1 style="color: #FFFFFF !important; margin: 0; font-size: 2.1rem; letter-spacing: 3px; font-weight: 700; font-family: 'Montserrat', sans-serif; text-transform: uppercase;">АРХИВ АРТЕФАКТОВ И БАЗА ЗНАНИЙ</h1>
        <p style="color: #BEAF87; margin: 8px 0 0 0; font-size: 0.95rem; text-transform: uppercase; letter-spacing: 1.5px; font-weight: 600;">Скачивайте оригинальные файлы калькуляторов, дорожных карт, аттестаций и дашбордов в высоком качестве</p>
    </div>
    """, unsafe_allow_html=True)
...
def show_corporate_footer():
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; color: #888888; font-size: 0.8rem; font-family: 'Montserrat', sans-serif;">
