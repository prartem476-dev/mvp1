...
<div style="padding: 12px; border-radius: 4px; background-color: #1A1A1A; border: 1px solid #2D2D2D; text-align: center;">
    <p style="font-size: 0.8rem; margin: 0; color: #C5A059; font-family: 'Barlow', sans-serif; font-weight: 700; text-transform: uppercase; letter-spacing: 1px;"><b>Версия MVP: 21.0 (Премиальная Экосистема C21)</b></p>
...
📚 **Документы:** Книга Брокера (Глава 2, «Руководство по регистрации бизнеса»).""",
            ...
            },
            {
                ...
                "tool_desc": """🤖 **Интерактивные инструменты:**
* Перейдите в раздел **🤖 ИИ-Консультант CENTURY 21** и задайте вопрос: *«Что такое ПОД/ФТ и требования?»* для получения моментальной справки.
...
* СДО **edu.century21.ru** для дистанционного прохождения курса CREATE 21.""",
        ...
        for idx, row in filtered_tasks.iterrows():
            ...
            with st.expander(f"{status_color} {row['task']} (Неделя {row['week']})"):
                ...
                if "download_file" in row and row["download_file"] and row["download_file"] is not None:
...
def show_corporate_footer():
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; color: #888888; font-size: 0.8rem; font-family: 'Barlow', sans-serif;">
        <div><b>©2026 CENTURY 21 Россия</b> • Корпоративная экосистема брокера v21.0 (Регистрация & Юридический комплаенс v13). CENTURY 21® зарегистрированный товарный знак (знак обслуживания), принадлежит компании Century 21 Real Estate LLC. [83]</div>
