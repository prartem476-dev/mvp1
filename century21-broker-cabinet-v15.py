...
# ==============================================================================
    ...
    st.markdown("""
    <div style="background-color: #111111; padding: 25px 30px; border-left: 5px solid #C5A059; border-radius: 4px; margin-bottom: 30px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
        <h1 style="color: #FFFFFF !important; margin: 0; font-size: 2.1rem; letter-spacing: 3px; font-weight: 700; font-family: 'Barlow', sans-serif; text-transform: uppercase;">🗺️ Интерактивный онбординг франчайзи</h1>
        <p style="color: #C5A059; margin: 8px 0 0 0; font-size: 0.95rem; text-transform: uppercase; letter-spacing: 1.5px; font-weight: 600;">Пошаговое интерактивное руководство по запуску франчайзи по стандартам бренда CENTURY 21</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with col_t1:
        st.markdown("""
        <div style="background-color: #FFFFFF; padding: 20px; border-radius: 4px; border: 1px solid #E2E2E6; border-top: 4px solid #C5A059; text-align: center; height: 180px;">
            ...
            <h2 style="margin: 10px 0; color: #C5A059 !important; font-size: 1.8rem; font-weight: 800; font-family: 'Barlow', sans-serif;">до 6 МЕСЯЦЕВ</h2>
    ...
    with col_t2:
        st.markdown("""
        <div style="background-color: #FFFFFF; padding: 20px; border-radius: 4px; border: 1px solid #E2E2E6; border-top: 4px solid #111111; text-align: center; height: 180px;">
            ...
            <h2 style="margin: 10px 0; color: #111111 !important; font-size: 1.8rem; font-weight: 800; font-family: 'Barlow', sans-serif;">10 – 12 МЕСЯЦЕВ</h2>
    ...
    with col_t3:
        ...
        <div style="background-color: #FFFFFF; padding: 20px; border-radius: 4px; border: 1px solid #E2E2E6; border-top: 4px solid #C5A059; text-align: center; height: 180px;">
            ...
            <h2 style="margin: 10px 0; color: #C5A059 !important; font-size: 1.8rem; font-weight: 800; font-family: 'Barlow', sans-serif;">15 – 18 МЕСЯЦЕВ</h2>
    ...
    with col_perc:
        st.markdown(f"<h3 style='color: #C5A059 !important; margin: 5px 0 0 0; text-align: right;'>{completion_percentage:.1f}%</h3>", unsafe_allow_html=True)
    ...
    with tab_p1:
        st.markdown("""
        <div style="padding: 15px; background-color: #FFFFFF; border-radius: 4px; margin-bottom: 25px; border-left: 5px solid #C5A059; border: 1px solid #E2E2E6; border-left: 5px solid #C5A059;">
            <b style="color: #111111;">ФОКУС ЭТАПА:</b> Юридическое оформление, поиск локации, брендинг и техническая подготовка рабочего пространства.
        </div>
        """, unsafe_allow_html=True)
    ...
    with tab_p2:
        st.markdown("""
        <div style="padding: 15px; background-color: #FFFFFF; border-radius: 4px; margin-bottom: 25px; border-left: 5px solid #C5A059; border: 1px solid #E2E2E6;">
            <b style="color: #111111;">ФОКУС ЭТАПА:</b> Обучение собственника, запуск найма, подключение РОПа и интеграция в экосистему УК.
        </div>
        """, unsafe_allow_html=True)
    ...
    with tab_p3:
        st.markdown("""
        <div style="padding: 15px; background-color: #FFFFFF; border-radius: 4px; margin-bottom: 25px; border-left: 5px solid #C5A059; border: 1px solid #E2E2E6;">
            <b style="color: #111111;">ФОКУС ЭТАПА:</b> Старт работы с лидами, адаптация первой волны агентов, внедрение KPI контроля и выход на окупаемость.
        </div>
        """, unsafe_allow_html=True)
