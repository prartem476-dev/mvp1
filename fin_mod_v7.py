...
st.set_page_config(
    page_title="CENTURY 21 Financial Model MVP v7",
    page_icon="💼",
    layout="wide",
...
# ШАПКА ПРИЛОЖЕНИЯ
# ----------------------------------------------------
st.markdown("<div class='main-title'>CENTURY 21 Financial Application (v7)</div>", unsafe_allow_html=True)
...
with tab1:
    ...
    fig_pie = px.pie(
        ...
        color_discrete_sequence=['#C2A24D', '#E2C26D', '#555555', '#333333', '#888888', '#aaaaaa', '#777777', '#C2A24D', '#222222'],
...
with tab2:
    ...
    if openpyxl_available:
        def generate_excel():
            ...
            category_fill = PatternFill(start_color="EAEAEA", end_color="EAEAEA", fill_type="solid")
