...
st.set_page_config(
    page_title="CENTURY 21 Financial Model (Бюджет Оптимальный) v22",
    page_icon="💼",
    layout="wide",
    ...
    with calc_tab4:
        ...
        def get_def_hc(role_clean, month_idx):
            ...
            if clean_role == 'Итого: агенты':
                return 0
            return DEFAULT_HEADCOUNTS.get(clean_role, [0]*24)[month_idx]
        ...
        with col_gen_left:
            ...
            g_role = st.selectbox(
                ...
                options=[r for r in staff_labels_1year if "Итого" not in r],
        ...
        for m_str in m_cols:
            col_config_stf_1y[m_str] = st.column_config.NumberColumn(format="%d чел.", min_value=0)
