...
<div style="padding: 12px; border-radius: 4px; background-color: #1A1A1A; border: 1px solid #2D2D2D; text-align: center;">
    <p style="font-size: 0.8rem; margin: 0; color: #C5A059; font-family: 'Barlow', sans-serif; font-weight: 700; text-transform: uppercase; letter-spacing: 1px;"><b>Версия MVP: 27.0 (Синхронизированная Экосистема C21)</b></p>
...
# ==============================================================================
    ...
    tab_8weeks, tab_13steps, tab_registration, tab_legal_tech, tab_crm_uk, tab_billing = st.tabs([
        ...
        "💳 Биллинг & Финансовый комплаенс сети"
    ])
...
* СДО **edu.century21.ru** для дистанционного прохождения курса CREATE 21.""",
    ...
    with tab_billing:
        st.markdown("""
        ### 💳 Биллинг, Роялти и Финансовый Мониторинг сети
        *Этот раздел оцифровывает финансовый комплаенс, сбор 6% роялти сети CENTURY 21, учет пени и дебиторской задолженности. Данные хранятся в защищенной СУБД SQLite.*
        """)
...
def show_corporate_footer():
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; color: #888888; font-size: 0.8rem; font-family: 'Barlow', sans-serif;">
        <div><b>©2026 CENTURY 21 Россия</b> • Корпоративная экосистема брокера v27.0 (Регистрация & Юридический комплаенс v13). CENTURY 21® зарегистрированный товарный знак (знак обслуживания), принадлежит компании Century 21 Real Estate LLC. [83]</div>
