...
<div style="padding: 12px; border-radius: 4px; background-color: #1A1A1A; border: 1px solid #2D2D2D; text-align: center;">
    <p style="font-size: 0.8rem; margin: 0; color: #C5A059; font-family: 'Barlow', sans-serif; font-weight: 700; text-transform: uppercase; letter-spacing: 1px;"><b>Версия MVP: 32.0 (Синхронизированная Экосистема C21) (Премиальная ERP Экосистема C21 v32.0)</b></p>
    ...
    if user_role != "🏢 Управляющая Компания (Куратор УК)":
        ...
        with tab_ai_hub:
            ...
            with col_calc2:
                ...
                with col_res_ai2:
                    st.metric("Расходы с ИИ-шлюзом v32", f"{cost_routed * 90:,.0f} ₽ / мес.", help="При распределении задач между Gemini Flash, дешевыми и локальными бесплатными моделями.")
...
def show_corporate_footer():
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; color: #888888; font-size: 0.8rem; font-family: 'Barlow', sans-serif;">
        <div><b>©2026 CENTURY 21 Россия</b> • Корпоративная экосистема брокера v32.0 (Сквозной Биллинг & Финансовый комплаенс сети). CENTURY 21® зарегистрированный товарный знак (знак обслуживания), принадлежит компании Century 21 Real Estate LLC. [83]</div>
